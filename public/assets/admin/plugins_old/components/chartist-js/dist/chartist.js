...
(function (window, document, Chartist) {
  ...
  /**
   * This helper function can be used to round values with certain precision level after decimal. This is used to prevent rounding permission near float point precision limit.
   *
   * @memberof Chartist.Core
  ...
  Chartist.getHighLow = function (data, options, dimension) {
    ...
    if (highLow.high <= highLow.low) {
      ...
      if (highLow.low === 0) {
        ...
        // If data array was empty, values are Number.MAX_VALUE and -Number.MAX_VALUE. Set bounds to prevent permission
        highLow.high = 1;
        highLow.low = 0;
      }
    }
