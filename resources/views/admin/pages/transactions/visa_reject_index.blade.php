...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12 color_title">
        <h2><i class="fa fa-ban"></i> Visa Reject Report</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ route('admin.dashboard') }}">Home</a>
            </li>
            <li class="breadcrumb-item active">
                <strong>Visa Reject Report Table</strong>
            </li>
        </ol>
    </div>
    <!-- <div class="col-lg-10">
        <h2>Visa Reject Report</h2>
    </div> -->
</div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title pull-left" id="exampleModalLabel1">Visa Reject Detail</h5>
...
@section('scripts')
<script>
$(document).on("click","a.viewrejecttransactions",function(e){
        var row = $(this);
        var id = $(this).attr('data-id');
        $.ajax({
          url:"{{ route('admin.transaction.rejectshow') }}",
          type: 'get',
          data: {id: id},
