...
<div class="row">
    <div class="col-lg-6">
        <div class="form-group  row {{ $errors->has('name') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-8">{!! Form::text('name',null,[
		'class' => 'form-control',
		'id'	=> 'name'
		]) !!}
        ...
        <div class="form-group row {{ $errors->has('email') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-8">{!! Form::text('email',null,[
		'class' => 'form-control',
		'id'	=> 'email'
		]) !!}
                <span class="help-block">
        ...
        <div class="form-group row {{ $errors->has('mobile') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-8">{!! Form::text('mobile',null,[
		'class' => 'form-control',
        ...
        <div class="form-group row {{ $errors->has('passport') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-8">{!! Form::text('passport',null,[
		'class' => 'form-control',
		'id'	=> 'passport'
		]) !!}
                <span class="help-block">
        ...
        <div class="form-group row {{ $errors->has('wpmobile') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-8">{!! Form::text('wpmobile',null,[
		'class' => 'form-control',
    ...
    <div class="col-lg-6">
        <div class="form-group row {{ $errors->has('passport_issue_date') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-8">
                {!! Form::text('passport_issue_date', '', array('id' => 'passport_issue_date','class' => 'form-control')) !!}
                <span class="help-block">
        ...
        <div class="form-group row {{ $errors->has('passport_expiry_date') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-8">
                {!! Form::text('passport_expiry_date', '', array('id' => 'passport_expiry_date','class' => 'form-control')) !!}
                <span class="help-block">
